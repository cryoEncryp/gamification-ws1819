...
public class TestData : MonoBehaviour {
    ...
    void Start() {
        ...
        if (INJECT_TESTDATA) {
            ...
            GameManager.instance.workoutHistory.Add(DateTime.Parse("8/01/2019", new CultureInfo("de-DE", true)), new List<WorkoutSession>(new WorkoutSession[] { new WorkoutSession(19, 400f, 400f, 125) }));
